	function summaryGalo(){
		...
		if(seven!=null){
			...
			for(var i = 0; i< sevenStored.data.length; i++){
				...
				var tdAbsent = document.createTextNode(sevenStored.data[i].absent);
		...
		if(eight!=null){
			...
			for(var i = 0; i< eightStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(eightStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
		...
		if(nine!=null){
			...
			for(var i = 0; i< nineStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(nineStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
		...
		if(ten!=null){
			...
			for(var i = 0; i< tenStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(tenStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
				...
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode(tenStored.data[i].late);
				td4.appendChild(tdLate);
				tr.appendChild(td1);
				tr.appendChild(td2);
				tr.appendChild(td3);
		...
		if(eleven!=null){
			...
			for(var i = 0; i< elevenStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(elevenStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
				...
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode(elevenStored.data[i].late);
				td4.appendChild(tdLate);
				tr.appendChild(td1);
				tr.appendChild(td2);
				tr.appendChild(td3);
		...
		if(twelve!=null){
			...
			for(var i = 0; i< twelveStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(twelveStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
				...
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode(twelveStored.data[i].late);
				td4.appendChild(tdLate);
				tr.appendChild(td1);
				tr.appendChild(td2);
				tr.appendChild(td3);
		...
		if(one!=null){
			...
			for(var i = 0; i< oneStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(oneStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
				...
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode(oneStored.data[i].late);
				td4.appendChild(tdLate);
				tr.appendChild(td1);
				tr.appendChild(td2);
				tr.appendChild(td3);
		...
		if(two!=null){
			...
			for(var i = 0; i< twoStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(twoStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
				...
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode(twoStored.data[i].late);
				td4.appendChild(tdLate);
				tr.appendChild(td1);
				tr.appendChild(td2);
				tr.appendChild(td3);
		...
		if(three!=null){
			...
			for(var i = 0; i< threeStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(threeStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
				...
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode(threeStored.data[i].late);
				td4.appendChild(tdLate);
				tr.appendChild(td1);
				tr.appendChild(td2);
				tr.appendChild(td3);
		...
		if(four!=null){
			...
			for(var i = 0; i< fourStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(fourStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
				...
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode(fourStored.data[i].late);
				td4.appendChild(tdLate);
				tr.appendChild(td1);
				tr.appendChild(td2);
				tr.appendChild(td3);
		...
		if(five!=null){
			...
			for(var i = 0; i< fiveStored.data.length; i++){
				...
				td2.appendChild(tdName);
				var td3 = document.createElement("td");
				var tdAbsent = document.createTextNode(fiveStored.data[i].absent);
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode("----------");
				td4.appendChild(tdLate);
				...
				td3.appendChild(tdAbsent);
				var td4 = document.createElement("td");
				var tdLate = document.createTextNode(fiveStored.data[i].late);
				td4.appendChild(tdLate);
				tr.appendChild(td1);
				tr.appendChild(td2);
				tr.appendChild(td3);
